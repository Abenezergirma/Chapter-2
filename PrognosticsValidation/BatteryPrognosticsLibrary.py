...
class BatteryPrognostics:
    ...
    def run_estimator(self):
        ...
        example_measurements = {"t": 292.2, "v": 24.0}
    ...
    def save_prognostics_output(self,mc_results):
        ...
        prog_results_file = os.path.join(current_directory,"ValidationResults/Pickles/prog_results_{}.pkl".format(self.experiment_index))

...
if __name__ == "__main__":
    ...
    for expt in range(0,1):
        results_directory = os.path.join(current_directory, "..", "longMissionSimulationParams.mat")
        pickle_path = current_directory #os.path.join(current_directory, "..", "BatteryPrognosticsResults/Pickles/prog_results_{}.pkl".format(experiment))
        experiment = BatteryExperiment(results_directory,pickle_path, expt)
        experiment.run()
